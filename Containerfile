...
# architecture here.
FROM --platform=$BUILDPLATFORM docker.io/library/maven:3-eclipse-temurin-26@sha256:c30718f442eb39c55b2d45440bb849d8755ad8d9d6ef67aadefcce150267116f AS build
